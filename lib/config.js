...
const Config = function () {
  ...
  this.sign_widevine = false
  this.sign_widevine_passphrase = ''
...
Config.prototype.buildArgs = function () {
  ...
  let args = {
    ...
    sign_widevine: this.sign_widevine,
    sign_widevine_passphrase: this.sign_widevine_passphrase,
    sign_widevine_key: this.sign_widevine_key,
    sign_widevine_cert: this.sign_widevine_cert,
  }
