...
Config.prototype.buildArgs = function () {
  ...
  let args = {
    ...
    sign_widevine: getNPMConfig(['sign_widevine']) || false,
    sign_widevine_passphrase: getNPMConfig(['sign_widevine_passphrase']) || '',
    sign_widevine_key: getNPMConfig(['sign_widevine_key']) || '',
    sign_widevine_cert: getNPMConfig(['sign_widevine_cert']) || '',
  }
